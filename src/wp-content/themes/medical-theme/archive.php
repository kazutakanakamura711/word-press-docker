...
<main class="max-w-6xl mx-auto px-4 py-16">
    <h1 class="text-3xl font-bold text-gray-900 mb-10">
        ...
        echo $obj instanceof WP_Post_Type ? esc_html($obj->label) : post_type_archive_title('', false);
        ?>
    </h1>
                ...
                <article class="bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                    <?php if (has_post_thumbnail()): ?>
                        <a href="<?php the_permalink(); ?>" class="block overflow-hidden">
                            <?php the_post_thumbnail('medium', ['class' => 'w-full h-48 object-cover hover:scale-105 transition-transform duration-300']); ?>
                        </a>
                    <?php endif; ?>
                    <div class="p-5">
