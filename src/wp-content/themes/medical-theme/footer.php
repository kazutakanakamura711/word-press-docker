    ...
    <div class="max-w-6xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                ...
                <p class="text-teal-200 text-sm leading-relaxed"><?php bloginfo(
                    'description',
                ); ?></p>
            </div>
                ...
                <table class="text-sm w-full">
                    <?php foreach ($footer_rows as $row): ?>
                        <tr class="border-b border-teal-800">
                            <td class="py-1 pr-3 font-medium w-12 <?php echo $row['closed']
                                ? 'text-red-300'
                                : 'text-teal-300'; ?>"><?php echo esc_html($row['day']); ?></td>
                            <td class="py-1 <?php echo $row['closed']
                                ? 'text-red-300'
                                : 'text-teal-200'; ?>"><?php echo esc_html($row['time']); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </table>
            </div>
