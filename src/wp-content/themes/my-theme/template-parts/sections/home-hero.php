...
$profile_img_url =
    $profile_img_url ?: get_template_directory_uri() . '/assets/images/img-profile.webp';
?>

<section class="p-home-hero" <?php if (
    $hero_img_url
): ?>style="background-image: url('<?php echo esc_url($hero_img_url); ?>');"<?php endif; ?>>
    <div class="p-home-hero__inner l-container">
        <div class="p-home-hero__profile">
            <div class="p-home-hero__avatar">
                <img src="<?php echo esc_url($profile_img_url); ?>" alt="<?php echo esc_attr(
    $site_name,
); ?>" loading="lazy">
            </div>
