...
$section_text = $apps_page ? apply_filters('the_content', $apps_page->post_excerpt ?: $apps_page->post_content) : '';
        ...
        <div class="p-home-applications__intro">
            <?php if ($section_img) : ?>
                <div class="p-home-applications__image">
                    <img src="<?php echo esc_url($section_img); ?>" alt="Applications" loading="lazy">
                </div>
            <?php endif; ?>
            <?php if ($section_text) : ?>
                ...
                <div class="swiper-slide">
                    <div class="c-app-card">
                        ...
                        <div class="c-app-card__body">
                            ...
                            <p class="c-app-card__text"><?php echo esc_html(get_the_excerpt() ?: wp_strip_all_tags(get_the_content())); ?></p>
                            <?php
                            ...
                            <div class="c-app-card__links">
                                <?php if ($app_url) : ?>
                                <a href="<?php echo esc_url($app_url); ?>" class="c-app-card__link" target="_blank" rel="noopener noreferrer">App</a>
                                <?php endif; ?>
                                <?php if ($github_url) : ?>
                                <a href="<?php echo esc_url($github_url); ?>" class="c-app-card__link" target="_blank" rel="noopener noreferrer">GitHub</a>
                                <?php endif; ?>
                            </div>
                            <?php endif; ?>
                        </div>
