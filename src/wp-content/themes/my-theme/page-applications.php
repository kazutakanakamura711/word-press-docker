                ...
                <article class="p-applications__item">
                    ...
                    <div class="p-applications__body">
                        ...
                        <div class="p-applications__links">
                            <?php if ($app_url) : ?>
                            <a href="<?php echo esc_url($app_url); ?>" class="c-button c-button--primary" target="_blank" rel="noopener noreferrer">App</a>
                            <?php endif; ?>
                            <?php if ($github_url) : ?>
                            <a href="<?php echo esc_url($github_url); ?>" class="c-button c-button--secondary" target="_blank" rel="noopener noreferrer">GitHub</a>
                            <?php endif; ?>
                        </div>
                        <?php endif; ?>
                    </div>
